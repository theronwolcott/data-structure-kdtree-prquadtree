...
public class PRQuadGrayNode extends PRQuadNode {
    ...
    public PRQuadNode insert(KDPoint p, int k) {
        ...
        // this.list[0][0] = new PRQuadBlackNode(newCentroid(this.centroid, k, "NW"), k
        // - 1,
        ...
        // this.list[1][0] = new PRQuadBlackNode(newCentroid(this.centroid, k, "SW"), k
        // - 1,
        // this.bucketingParam, p);
        // return this;
        // } else { // gray or black
        ...
        // this.list[0][1] = new PRQuadBlackNode(newCentroid(this.centroid, k, "NE"), k
        // - 1,
        // this.bucketingParam, p);
        // return this;
        // } else { // gray or black
        ...
        // this.list[1][1] = new PRQuadBlackNode(newCentroid(this.centroid, k, "SE"), k
        // - 1,
        // this.bucketingParam, p);
        // return this;
        // } else { // gray or black
